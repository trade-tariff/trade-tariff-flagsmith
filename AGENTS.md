...
This repository deploys self-hosted Flagsmith for the Online Trade Tariff platform. It runs the Flagsmith API/dashboard and edge proxy as ECS Fargate services. Supporting infrastructure lives in the platform Terraform repository.

## Working Rules

- Keep scope tight and prefer simple changes.
- Verify generated or AI-suggested claims against source code.
